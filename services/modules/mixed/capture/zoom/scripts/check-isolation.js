...
// Node builtins, or a DECLARED dep (dependencies OR devDependencies). Proves the
// mixed pipeline pulls only the shared engine (@vexa/transcribe-{buffer,whisper})
// + the pyannote runtime — no back-import into the old monolith.
