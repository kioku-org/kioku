...
impl KnowledgeService {
        ...
        for seg in segments {
            ...
            for text in sub_chunks {
                ...
                metadata.insert(
                    ...
                    serde_json::json!(meeting_id.to_string()),
                );
    ...
    pub async fn ingest_documents(
        ...
        for doc in docs {
            ...
            let metadata_json =
                serde_json::to_value(&doc.metadata).unwrap_or(serde_json::json!({}));
...
mod tests {
    ...
    fn test_split_text_overlap() {
        ...
        for i in 0..chunks.len().saturating_sub(1) {
            let end_words: Vec<&str> = chunks[i]
                .split_whitespace()
                .rev()
                .take(2)
                .collect::<Vec<_>>()
            ...
            assert_eq!(
                ...
                "Adjacent chunks should overlap by 2 words"
            );
        }
    }
    ...
    fn test_split_text_preserves_content() {
        ...
        for word in &original_words {
            assert!(
                ...
                "Word '{}' should be in reconstructed text",
                word
            );
        }
    }
