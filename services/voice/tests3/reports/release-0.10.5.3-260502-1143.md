# Release validation report — `0.10.5.3-260502-1143`

_Generated 2026-05-02T09:00:42.223432Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1143` | 21 | 19 | 2 |
| `helm` | `0.10.5.3-260502-1143` | 13 | 9 | 4 |
| `lite` | `0.10.5.3-260502-1143` | 10 | 8 | 2 |
...
| `bot-lifecycle` | **80%** | 90% | ❌ below gate |
...
| `containers` | ✅ pass | 109092 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 566 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1145 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 94 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 311 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91765 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 637 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5201 ms | 13 / 17 |
| `smoke-static` | ❌ fail | 585 ms | 90 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 344 ms | 3 / 3 |
...
| `webhooks` | ✅ pass | 96498 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 303 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 564 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 396 ms | 2 / 2 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 245 ms | 1 / 1 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ❌ fail | 241307 ms | 5 / 7 |
| `dashboard-auth` | ✅ pass | 1579 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3230 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 22232 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9169 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34365 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 2956 ms | 90 / 92 |
| `webhooks` | ✅ pass | 102809 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 158 ms | 1 / 1 |
| `containers` | ❌ fail | 25424 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 471 ms | 4 / 4 |
| `package-tests` | ✅ pass | 87 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 268 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39152 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 853 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5451 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 595 ms | 90 / 92 |
| `webhooks` | ✅ pass | 96195 ms | 10 / 10 |
