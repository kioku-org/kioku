# Release validation report — `0.10.0-260421-1620`

_Generated 2026-04-21T13:30:30.850092Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1620` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1620` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-1620` | 10 | 8 | 2 |
...
| `bot-lifecycle` | **58%** | 90% | ❌ below gate |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 99 ms | 1 / 1 |
| `containers` | ✅ pass | 109003 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 519 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1084 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 86 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 307 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91350 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 652 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5137 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 25 ms | 40 / 41 |
| `webhooks` | ✅ pass | 97100 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 296 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 550 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 362 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 230 ms | 1 / 1 |
| `containers` | ❌ fail | 11546 ms | 1 / 2 |
| `dashboard-auth` | ✅ pass | 1426 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1611 ms | 3 / 6 |
| `smoke-contract` | ❌ fail | 81642 ms | 23 / 27 |
| `smoke-env` | ✅ pass | 9601 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34620 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 537 ms | 40 / 41 |
| `webhooks` | ✅ pass | 92699 ms | 9 / 10 |
...
| `containers` | ❌ fail | 25407 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 511 ms | 4 / 4 |
| `package-tests` | ✅ pass | 85 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 272 ms | 4 / 4 |
| `smoke-contract` | ❌ fail | 64587 ms | 21 / 27 |
| `smoke-env` | ✅ pass | 789 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5705 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 37 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96444 ms | 10 / 10 |
