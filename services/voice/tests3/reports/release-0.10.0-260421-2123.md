# Release validation report — `0.10.0-260421-2123`

_Generated 2026-04-21T18:34:36.764250Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-2123` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-2123` | 12 | 11 | 1 |
| `lite` | `0.10.0-260421-2123` | 10 | 9 | 1 |
...
| `containers` | ✅ pass | 109260 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 537 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1087 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 91 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 274 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91573 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 572 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5086 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 24 ms | 44 / 45 |
| `webhooks` | ✅ pass | 96630 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 317 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 576 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 379 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 247 ms | 1 / 1 |
| `containers` | ✅ pass | 114612 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1492 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3285 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 22501 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9547 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34895 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 587 ms | 44 / 45 |
| `webhooks` | ✅ pass | 103500 ms | 9 / 10 |
...
| `containers` | ❌ fail | 25482 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 450 ms | 4 / 4 |
| `package-tests` | ✅ pass | 79 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 278 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39430 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 841 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5994 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 25 ms | 44 / 45 |
| `webhooks` | ✅ pass | 96646 ms | 10 / 10 |
