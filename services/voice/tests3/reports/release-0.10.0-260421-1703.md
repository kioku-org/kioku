# Release validation report — `0.10.0-260421-1703`

_Generated 2026-04-21T14:59:40.438504Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1703` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1703` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-1703` | 10 | 9 | 1 |
...
| `bot-lifecycle` | **87%** | 90% | ❌ below gate |
...
| `containers` | ✅ pass | 109013 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 505 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1017 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 75 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 254 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91428 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 664 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5160 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 24 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96734 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 318 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 584 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 391 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 246 ms | 1 / 1 |
| `containers` | ❌ fail | 140734 ms | 5 / 7 |
| `dashboard-auth` | ✅ pass | 1466 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3154 ms | 4 / 6 |
| `smoke-contract` | ❌ fail | 22339 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9535 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34991 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 578 ms | 40 / 41 |
| `webhooks` | ✅ pass | 103374 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 83 ms | 1 / 1 |
| `containers` | ❌ fail | 25394 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 497 ms | 4 / 4 |
| `package-tests` | ✅ pass | 97 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 295 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39416 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 784 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5681 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 30 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96247 ms | 10 / 10 |
