# Release validation report — `0.10.5.3-260502-1035`

_Generated 2026-05-02T07:46:39.301751Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1035` | 20 | 18 | 2 |
| `helm` | `0.10.5.3-260502-1035` | 13 | 10 | 3 |
| `lite` | `0.10.5.3-260502-1035` | 10 | 8 | 2 |
...
| `containers` | ✅ pass | 109148 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 513 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1063 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 89 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 283 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 92043 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 651 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5168 ms | 13 / 17 |
| `smoke-static` | ❌ fail | 600 ms | 89 / 92 |
...
| `webhooks` | ✅ pass | 96851 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 319 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 586 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 393 ms | 2 / 2 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 228 ms | 1 / 1 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ✅ pass | 114534 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1572 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3355 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 23315 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9009 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 32270 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 2920 ms | 89 / 92 |
...
| `package-tests` | ✅ pass | 88 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 264 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39372 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 836 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5407 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 574 ms | 89 / 92 |
| `webhooks` | ✅ pass | 97831 ms | 10 / 10 |
