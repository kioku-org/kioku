# Release validation report — `0.10.0-260421-2103`

_Generated 2026-04-21T18:22:36.997459Z from `tests3/.state/reports/`._
...
|-------|----------------|-------------------|---------|
| `chart-every-prod-secret-via-secretkeyref` | helm | helm `HELM_PROD_SECRETS_SECRETREF_ONLY`: ✅ pass<br>helm `HELM_PROD_SECRETS_REQUIRED_AT_RENDER`: ✅ pass | **✅ pass** |
| `bot-recording-incremental-chunk-upload` | compose, helm | compose `RECORDING_UPLOAD_SUPPORTS_CHUNK_SEQ`: ✅ pass<br>lite `BOT_RECORDS_INCREMENTALLY`: ✅ pass<br>compose `BOT_RECORDS_INCREMENTALLY`: ✅ pass<br>compose `RECORDING_SURVIVES_MID_MEETING_KILL`: ✅ pass<br>helm `RUNTIME_API_STOP_GRACE_MATCHES_POD_SPEC`: ❌ fail | **❌ fail** |
| `transcript-rendering-dedup-prefers-confirmed-on-containment` | lite | lite `TRANSCRIPT_RENDERING_DEDUP_TESTS_PASS`: ✅ pass<br>lite `PACKAGES_CI_WORKFLOW_EXISTS`: ✅ pass | **✅ pass** |
| `engine-pool-reset-on-return-guarded` | compose, helm, lite | lite `ENGINE_POOL_RESET_ON_RETURN_ROLLBACK`: ✅ pass<br>compose `ENGINE_POOL_RESET_ON_RETURN_ROLLBACK`: ✅ pass<br>helm `HELM_ALL_SERVICES_DB_POOL_TUNED`: ✅ pass<br>compose `DB_POOL_NO_EXHAUSTION`: ✅ pass | **✅ pass** |
| `chart-rolling-update-zero-pool-overlap` | helm | helm `HELM_DEPLOYMENT_STRATEGY_HELPER_DEFINED`: ✅ pass<br>helm `HELM_ROLLING_UPDATE_ZERO_SURGE`: ✅ pass<br>helm `HELM_API_GATEWAY_REPLICA_COUNT_HA`: ✅ pass | **✅ pass** |
| `pgbouncer-as-optional-oss-chart-component` | helm | helm `HELM_PGBOUNCER_OPTIONAL_AND_WIRED`: ✅ pass | **✅ pass** |
| `runtime-api-exit-callback-delivery-is-durable` | compose | lite `RUNTIME_API_IDLE_LOOP_SWEEPS_PENDING_CALLBACKS`: ✅ pass<br>compose `RUNTIME_API_IDLE_LOOP_SWEEPS_PENDING_CALLBACKS`: ✅ pass<br>compose `RUNTIME_API_EXIT_CALLBACK_DURABLE`: ✅ pass | **✅ pass** |
| `lite-postgres-publicly-exposed` | compose, lite | lite `LITE_POSTGRES_NOT_PUBLIC`: ✅ pass<br>lite `LITE_INTERNAL_SERVICES_LOOPBACK_ONLY`: ✅ pass<br>lite `LITE_REDIS_NOT_PUBLIC`: ✅ pass<br>compose `COMPOSE_PORTS_LOOPBACK_ONLY`: ✅ pass | **✅ pass** |

## Deployment coverage

| Mode | Image tag | Tests run | Passed | Failed |
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-2103` | 11 | 9 | 2 |
| `helm` | `0.10.0-260421-2103` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-2103` | 10 | 8 | 2 |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 96 ms | 1 / 1 |
| `containers` | ✅ pass | 109247 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 531 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1056 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 91 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 288 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91445 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 559 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5052 ms | 13 / 17 |
| `smoke-static` | ❌ fail | 25 ms | 43 / 45 |
| `webhooks` | ✅ pass | 96914 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 315 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 574 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 399 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 247 ms | 1 / 1 |
| `containers` | ✅ pass | 193624 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1515 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3149 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 22717 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9784 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34291 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 585 ms | 43 / 45 |
| `webhooks` | ✅ pass | 103588 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 95 ms | 1 / 1 |
| `containers` | ❌ fail | 25448 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 514 ms | 4 / 4 |
| `package-tests` | ✅ pass | 87 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 265 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39337 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 734 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5594 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 35 ms | 43 / 45 |
| `webhooks` | ✅ pass | 96524 ms | 10 / 10 |
