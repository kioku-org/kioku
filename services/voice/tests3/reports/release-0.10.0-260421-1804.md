# Release validation report — `0.10.0-260421-1804`

_Generated 2026-04-21T15:21:59.131554Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1804` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1804` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-1804` | 10 | 8 | 2 |
...
| `containers` | ✅ pass | 108843 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 490 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1109 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 87 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 282 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91817 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 675 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5658 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 24 ms | 40 / 41 |
| `webhooks` | ✅ pass | 97000 ms | 10 / 10 |
...
| `chart-pgbouncer-optional` | ✅ pass | 573 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 398 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 249 ms | 1 / 1 |
| `containers` | ❌ fail | 119752 ms | 5 / 7 |
| `dashboard-auth` | ✅ pass | 1450 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3224 ms | 4 / 6 |
| `smoke-contract` | ❌ fail | 22486 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9702 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34758 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 588 ms | 40 / 41 |
| `webhooks` | ✅ pass | 103589 ms | 9 / 10 |
...
| `containers` | ❌ fail | 25421 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 472 ms | 4 / 4 |
| `package-tests` | ✅ pass | 83 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 275 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39436 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 747 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5549 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 37 ms | 40 / 41 |
| `webhooks` | ❌ fail | 96476 ms | 9 / 10 |
