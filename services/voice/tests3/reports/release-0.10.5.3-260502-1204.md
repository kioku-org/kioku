# Release validation report — `0.10.5.3-260502-1204`

_Generated 2026-05-02T09:53:30.071138Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1204` | 21 | 19 | 2 |
| `helm` | `0.10.5.3-260502-1204` | 14 | 11 | 3 |
| `lite` | `0.10.5.3-260502-1204` | 11 | 9 | 2 |
...
| `containers` | ✅ pass | 119138 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 579 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1085 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 87 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 280 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91729 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 617 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5253 ms | 13 / 17 |
| `smoke-static` | ❌ fail | 592 ms | 90 / 92 |
...
| `chart-pgbouncer-optional` | ✅ pass | 575 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 392 ms | 2 / 2 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 254 ms | 1 / 1 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ✅ pass | 125068 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1603 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3504 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 24826 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 8869 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 32998 ms | 17 / 17 |
| `smoke-static` | ❌ fail | 2950 ms | 90 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 336 ms | 3 / 3 |
| `webhooks` | ✅ pass | 102923 ms | 9 / 10 |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 85 ms | 1 / 1 |
| `containers` | ❌ fail | 25382 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 474 ms | 4 / 4 |
| `package-tests` | ✅ pass | 83 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 267 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39347 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 754 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5404 ms | 12 / 17 |
| `smoke-static` | ❌ fail | 587 ms | 90 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 260 ms | 3 / 3 |
| `webhooks` | ✅ pass | 96331 ms | 10 / 10 |
