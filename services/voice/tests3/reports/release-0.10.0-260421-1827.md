# Release validation report — `0.10.0-260421-1827`

_Generated 2026-04-21T15:42:16.475657Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1827` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1827` | 12 | 11 | 1 |
| `lite` | `0.10.0-260421-1827` | 10 | 9 | 1 |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 104 ms | 1 / 1 |
| `containers` | ✅ pass | 108966 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 493 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1096 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 106 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 315 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91730 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 610 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5049 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 25 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96879 ms | 10 / 10 |

### `helm`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `chart-all-services-db-pool-tuned` | ✅ pass | 253 ms | 1 / 1 |
| `chart-pgbouncer-optional` | ✅ pass | 570 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 396 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 211 ms | 1 / 1 |
| `containers` | ✅ pass | 114487 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1479 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3270 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 23499 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9364 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34688 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 573 ms | 40 / 41 |
| `webhooks` | ✅ pass | 103411 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 85 ms | 1 / 1 |
| `containers` | ❌ fail | 25424 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 466 ms | 4 / 4 |
| `package-tests` | ✅ pass | 91 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 288 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39444 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 754 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5629 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 36 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96756 ms | 10 / 10 |
