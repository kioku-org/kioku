# Release validation report — `0.10.0-260421-1632`

_Generated 2026-04-21T13:43:31.085266Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1632` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1632` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-1632` | 10 | 8 | 2 |
...
| `containers` | ✅ pass | 109078 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 577 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1216 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 102 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 341 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91472 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 612 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5013 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 25 ms | 40 / 41 |
| `webhooks` | ✅ pass | 97082 ms | 10 / 10 |
...
| `chart-pgbouncer-optional` | ✅ pass | 527 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 389 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 251 ms | 1 / 1 |
| `containers` | ❌ fail | 11551 ms | 1 / 2 |
| `dashboard-auth` | ✅ pass | 1524 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1639 ms | 3 / 6 |
| `smoke-contract` | ❌ fail | 81345 ms | 23 / 27 |
| `smoke-env` | ✅ pass | 9640 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34430 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 545 ms | 40 / 41 |
| `webhooks` | ✅ pass | 92359 ms | 9 / 10 |
...
| `containers` | ❌ fail | 10408 ms | 1 / 2 |
| `dashboard-auth` | ✅ pass | 486 ms | 4 / 4 |
| `package-tests` | ✅ pass | 99 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 296 ms | 4 / 4 |
| `smoke-contract` | ❌ fail | 64444 ms | 21 / 27 |
| `smoke-env` | ✅ pass | 828 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5505 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 23 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96502 ms | 10 / 10 |
