# Release validation report — `0.10.0-260427-1802`

_Generated 2026-04-27T15:32:16.651182Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260427-1802` | 11 | 10 | 1 |
| `helm` | `0.10.0-260427-1802` | 12 | 7 | 5 |
| `lite` | `0.10.0-260427-1802` | 10 | 9 | 1 |
...
| `containers` | ✅ pass | 108932 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 558 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1059 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 90 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 278 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91270 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 589 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 4909 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 420 ms | 63 / 64 |
| `webhooks` | ✅ pass | 96585 ms | 10 / 10 |
...
| `chart-pgbouncer-optional` | ✅ pass | 538 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 404 ms | 2 / 2 |
| `chart-rolling-update-zero-surge` | ✅ pass | 248 ms | 1 / 1 |
| `containers` | ✅ pass | 114420 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1529 ms | 4 / 4 |
| `dashboard-proxy` | ❌ fail | 1367 ms | 1 / 6 |
| `smoke-contract` | ❌ fail | 22124 ms | 8 / 27 |
| `smoke-env` | ❌ fail | 9509 ms | 5 / 7 |
| `smoke-health` | ❌ fail | 29519 ms | 7 / 17 |
| `smoke-static` | ✅ pass | 2494 ms | 65 / 66 |
...
| `containers` | ❌ fail | 25396 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 450 ms | 4 / 4 |
| `package-tests` | ✅ pass | 79 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 287 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39285 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 788 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5276 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 383 ms | 63 / 64 |
| `webhooks` | ✅ pass | 96068 ms | 10 / 10 |
