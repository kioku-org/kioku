# Release validation report — `0.10.5.3-260502-1835`

_Generated 2026-05-02T15:49:20.933205Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1835` | 28 | 27 | 1 |
| `helm` | `0.10.5.3-260502-1835` | 15 | 13 | 2 |
| `lite` | `0.10.5.3-260502-1835` | 12 | 11 | 1 |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 103 ms | 1 / 1 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 242 ms | 1 / 1 |
| `containers` | ✅ pass | 119193 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 563 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1099 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 87 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 282 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91782 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 694 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5223 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 569 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 269 ms | 3 / 3 |
...
| `v0.10.6-static-greps` | ✅ pass | 792 ms | 12 / 12 |
...
| `containers` | ✅ pass | 124752 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 1459 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3578 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 23847 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9352 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34357 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 2881 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 345 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 1060 ms | 12 / 12 |
| `webhooks` | ✅ pass | 103504 ms | 9 / 10 |
...
| `runtime-api-exit-callback-durable` | ✅ pass | 280 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 40264 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 820 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5280 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 592 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 258 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 780 ms | 12 / 12 |
