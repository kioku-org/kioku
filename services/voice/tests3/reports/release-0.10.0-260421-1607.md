# Release validation report — `0.10.0-260421-1607`

_Generated 2026-04-21T13:17:34.678474Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.0-260421-1607` | 11 | 10 | 1 |
| `helm` | `0.10.0-260421-1607` | 12 | 10 | 2 |
| `lite` | `0.10.0-260421-1607` | 10 | 7 | 3 |
...
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 84 ms | 1 / 1 |
| `containers` | ✅ pass | 108910 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 476 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1116 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 86 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 274 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91977 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 720 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5200 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 24 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96926 ms | 10 / 10 |
...
| `chart-rolling-update-zero-surge` | ✅ pass | 250 ms | 1 / 1 |
| `containers` | ❌ fail | 11568 ms | 1 / 2 |
| `dashboard-auth` | ✅ pass | 1411 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1695 ms | 3 / 6 |
| `smoke-contract` | ❌ fail | 81382 ms | 23 / 27 |
| `smoke-env` | ✅ pass | 9611 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 34608 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 582 ms | 40 / 41 |
| `webhooks` | ✅ pass | 92623 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 87 ms | 1 / 1 |
| `containers` | ❌ fail | 25420 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 454 ms | 4 / 4 |
| `package-tests` | ❌ fail | 31 ms | 0 / 0 |
| `runtime-api-exit-callback-durable` | ✅ pass | 276 ms | 4 / 4 |
| `smoke-contract` | ❌ fail | 64509 ms | 21 / 27 |
| `smoke-env` | ✅ pass | 804 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5493 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 33 ms | 40 / 41 |
| `webhooks` | ✅ pass | 96280 ms | 10 / 10 |
