# Release validation report — `0.10.5.3-260502-1637`

_Generated 2026-05-02T15:26:45.697991Z from `tests3/.state/reports/`._
...
|------|-----------|-----------|--------|--------|
| `compose` | `0.10.5.3-260502-1637` | 28 | 27 | 1 |
| `helm` | `0.10.5.3-260502-1637` | 15 | 13 | 2 |
| `lite` | `0.10.5.3-260502-1637` | 12 | 11 | 1 |
...
### `post-meeting-transcription` (82% / gate 60%)
...
| `containers` | ✅ pass | 119145 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 571 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 1164 ms | 5 / 6 |
| `recording-survives-sigkill` | ✅ pass | 91 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 297 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 91854 ms | 27 / 27 |
| `smoke-env` | ❌ fail | 618 ms | 6 / 7 |
| `smoke-health` | ✅ pass | 5234 ms | 13 / 17 |
| `smoke-static` | ✅ pass | 700 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 242 ms | 3 / 3 |
...
| `v0.10.6-static-greps` | ✅ pass | 710 ms | 11 / 11 |
...
| `chart-pgbouncer-optional` | ✅ pass | 563 ms | 4 / 4 |
| `chart-prod-secrets-secretref` | ✅ pass | 401 ms | 2 / 2 |
| `chart-rolling-update-zero-downtime` | ✅ pass | 249 ms | 1 / 1 |
| `chart-rolling-update-zero-surge` | ❌ fail | 253 ms | 0 / 1 |
| `containers` | ✅ pass | 124670 ms | 6 / 7 |
| `dashboard-auth` | ✅ pass | 2182 ms | 4 / 4 |
| `dashboard-proxy` | ✅ pass | 3374 ms | 5 / 6 |
| `smoke-contract` | ❌ fail | 22039 ms | 25 / 27 |
| `smoke-env` | ✅ pass | 9573 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 33353 ms | 17 / 17 |
| `smoke-static` | ✅ pass | 2904 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 331 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 940 ms | 11 / 11 |
| `webhooks` | ✅ pass | 103658 ms | 9 / 10 |

### `lite`

| Test | Status | Duration | Steps (pass / total) |
|------|:------:|---------:|---------------------:|
| `bot-records-incrementally` | ✅ pass | 122 ms | 1 / 1 |
| `containers` | ❌ fail | 25413 ms | 2 / 2 |
| `dashboard-auth` | ✅ pass | 451 ms | 4 / 4 |
| `package-tests` | ✅ pass | 79 ms | 1 / 1 |
| `runtime-api-exit-callback-durable` | ✅ pass | 295 ms | 4 / 4 |
| `smoke-contract` | ✅ pass | 39570 ms | 22 / 27 |
| `smoke-env` | ✅ pass | 856 ms | 7 / 7 |
| `smoke-health` | ✅ pass | 5425 ms | 12 / 17 |
| `smoke-static` | ✅ pass | 636 ms | 91 / 92 |
| `v0.10.5.3-hallucination-corpus` | ✅ pass | 241 ms | 3 / 3 |
| `v0.10.6-static-greps` | ✅ pass | 677 ms | 11 / 11 |
| `webhooks` | ✅ pass | 96235 ms | 10 / 10 |
