...
// Kioku — context infrastructure client

// Usage: kioku [OPTIONS] [COMMAND]

// Commands:
//   signin       Sign in with Google, GitHub or an API key
//   signout      Sign out and clear stored credentials
//   whoami       Show current user and server
//   search       Search your knowledge base
//   docs         List documents, upload a new one, or delete one
//   meet         List running meeting bots, join a meeting, or kill a bot
//   cal          List Google Calendar meetings for today, the coming week, or a date
//   keys         List API keys, create a new one, or delete one
//   mcp          Print MCP server config for AI clients (Claude, Cursor, etc.)
//   upgrade      Check for updates and upgrade if a newer version is available
//   completions  Generate shell completion script
//   help         Print this message or the help of the given subcommand(s)


// Usage: kioku signin [OPTIONS]

// Options:
//       --api-key <API_KEY>  Sign in using a long-lived API key instead of OAuth
//       --calendar           Grant kioku read-only access to your Google Calendar (used by `kioku cal`)
//   -C, --cwd <CWD>          
//       --server <SERVER>    
//   -v, --verbose...         
//       --json               Print machine-readable JSON instead of formatted text
//       --token              Print stored auth token (useful for scripting)
//   -h, --help               Print help


// Usage: kioku meet [OPTIONS] [LINK]

// Arguments:
//   [LINK]  Meeting link to join (Google Meet, Teams, or Zoom — auto-detected). Pass `ls` to list.

// Options:
//       --kill <BOT>       Stop a running meeting bot, by meeting id or id prefix
//   -C, --cwd <CWD>        
//       --server <SERVER>  
//   -v, --verbose...       
//       --json             Print machine-readable JSON instead of formatted text
//       --transcript <MEETING_ID>  Print the transcript for a specific meeting
//   -h, --help             Print help
