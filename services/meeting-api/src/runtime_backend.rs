...
mod tests {
    ...
    fn test_config(use_local: bool, threshold: i64) -> Config {
        Config {
            ...
            redis_stream_name: "transcription_segments".to_string(),
            redis_consumer_group: "collector_group".to_string(),
            consumer_name: "collector-main".to_string(),
            pending_msg_timeout_ms: 60000,
            redis_stream_read_count: 10,
            redis_stream_block_ms: 2000,
            redis_speaker_events_stream_name: "speaker_events_relative".to_string(),
            redis_speaker_events_consumer_group: "collector_speaker_group".to_string(),
            redis_speaker_event_key_prefix: "speaker_events".to_string(),
            redis_speaker_event_ttl: 86400,
            background_task_interval_secs: 10,
            immutability_threshold_secs: 30,
            redis_segment_ttl: 3600,
            cookie_storage_backend: "s3".to_string(),
            cookie_service_url: String::new(),
            cookie_service_token: String::new(),
