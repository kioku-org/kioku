...
# Where bots send audio for transcription. Default: their own in-pod service.
# Set to http://kioku-whisper:8000 (with the shared-whisper compose profile) to
